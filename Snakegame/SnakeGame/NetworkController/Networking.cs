...
public static class Networking
{
    ...
    private static void ReceiveCallback(IAsyncResult ar)
    {
        ...
        {
            // Setting ErrorOccurred and ErrorMessage
            socketState.ErrorOccurred = true;
            socketState.ErrorMessage = "An error occurred while receiving the callback";

            // Invoke the OnNetworkAction with the socketState(error)
